...
> [Want to be a sponsor?](https://github.com/spiritLHLS/ecs/issues)

<i style="color: gray; font-size: small;">※ The sponsor only sponsors this repository project and is not related to the Go version project outside this repository.</i>
...
<td><b>IPWO Residential Proxy</b> — Reliable residential proxy network for simulating real user access environments, IP geolocation verification, and regional access testing. Supports http/https/socks5 multi-protocol.<br><a href="https://www.ipwo.net/?ref=githubspiritLHLS" target="_blank"><u>Test Access Entry</u></a> ｜ Discount Code: <b>LHLS</b></td>
</tr>
</table>
...
- The downloaded `speedtest-go` binary is now `v1.8.2`; upstream adds a unique cache-bypass parameter to the speedtest.net client-config request.
